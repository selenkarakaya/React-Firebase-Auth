  ...
  useEffect(() => {
    const fetchfeedback = async () => {
      try {
        ...
        console.log(error);
        toast.error("Could not display your recipes");
      }
    };
    fetchfeedback();
    ...
    return (
      <>
        <div className="flex flex-col items-center mt-6 border-t border-dotted border-mediumOrange">
          <h1 className="text-2xl">Fresh from the customers</h1>
          <p className="text-xl">
            Check out what our customers have to say about their Riverside Box
            experience!
          </p>
        </div>
        <main>
