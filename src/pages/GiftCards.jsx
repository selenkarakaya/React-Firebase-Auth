    ...
    <div>
      ...
      <section id="buyGiftCard">
        ...
        <div className="flex justify-end mx-20">
          <button className="w-2/3 bg-darkGreen py-4 rounded-2xl hover:bg-greens hover:text-white">
